...
class UniversalI18nManager:
    ...
    def save_custom_translations(self, lang_code: str, file_path: str | None = None):
        ...
        try:
            with open(file_path, "w", encoding="utf-8") as f:
                json.dump(self.custom_translations[lang_code], f, 
    ...
    def validate_translations(self, lang_code: str) -> Dict[str, list[str]]:
        ...
        if lang_code in self.custom_translations:
            self._validate_recursive(self.custom_translations[lang_code], lang_code, "", missing)
        
        return missing
    
    def _validate_recursive(self, translations: Dict[str, Any], lang_code: str, 
                          prefix: str, missing: Dict[str, list[str]]):
        """
